...
param_range = np.linspace(1, 40, 10).astype(int)
...
title = "Learning Curves (KNN, N Neighbors=5)"
# Cross validation with 100 iterations to get smoother mean test and train
# score curves, each time with 20% data randomly selected as a validation set.
classifier = classifier = KNeighborsClassifier(metric='minkowski', p=2, n_neighbors=5)
