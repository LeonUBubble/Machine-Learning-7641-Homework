...
public class phishing_sa {
    ...
    private static Instance[] train_set = Arrays.copyOfRange(instances, 0, 3551);
    private static Instance[] test_set = Arrays.copyOfRange(instances, 3551, 5074);
    ...
    public static void main(String[] args) {
        ...
        int[] iterations = {10, 100, 300, 600, 1000, 1500};
    ...
    private static Instance[] initializeInstances() {
        ...
        double[][][] attributes = new double[5074][][];

        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("src/opt/xliang75/phishing.csv")));
